...
DATASET_ID=302
PATH_TO_CHECKPOINT=/home/gridsan/nchutisilp/projects/OpenAI-CLIP/logs/CLIP_PreIVL_PostStent_wd/nnunet.pt
...
OUTPUT_DIR=$nnUNet_results/Dataset302_Calcium_OCTv2/${TRAINER}__nnUNetPlans__${CONFIG}/fold_${FOLD}_pretrained_with_CLIP_PreIVL_PostStent_test
