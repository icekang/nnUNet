...
DATASET_ID=302
TRAINER=nnUNetTrainerScaleAnalysis2
...
echo "Renaming $TRAINING_OUTPUT_DIR to $TRAINING_OUTPUT_DIR"_Genesis""
mv $TRAINING_OUTPUT_DIR $TRAINING_OUTPUT_DIR"_Genesis"
