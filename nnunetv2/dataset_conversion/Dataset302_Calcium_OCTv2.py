...
def get_splits():
    ...
    """
    samples = ['101-019', '101-044', '101-045', '106-002', '401-004', '701-013', '704-003', '706-005']
    train = ['101-044', '704-003', '101-019', '401-004', '106-002', '701-013']
    test = ['706-005', '101-045']
    return train, test
