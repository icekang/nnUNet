...
class nnUNetTrainerScaleAnalysis3(nnUNetTrainer):
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits_file = join(self.preprocessed_dataset_folder_base, "splits_final_3.json")

            if not isfile(splits_file):
                raise ValueError("splits_final_3.json does not exist. You need to create it.")
